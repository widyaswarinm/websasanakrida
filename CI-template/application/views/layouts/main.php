    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="<?php echo base_url();?>assets/javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                <a href="<?php echo base_url();?>assets/javascript:void(0);" class="bars"></a>
                <a class="navbar-brand" href=" <?php echo base_url();?>view/dashboard.php">ADMINBSB - MATERIAL DESIGN</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li><a href="<?php echo base_url();?>assets/javascript:void(0);" class="js-search" data-close="true"><i class="material-icons">search</i></a></li>
                    <!-- #END# Call Search -->
                    <!-- Notifications -->
                    <li class="dropdown">
                        <a href="<?php echo base_url();?>assets/javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="<?php echo base_url();?>assets/javascript:void(0);">View All Notifications</a>
                            </li>
                        </ul>
                    </li>
                    <!-- #END# Notifications -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="<?php echo base_url();?>assets/javascript:void(0);">View All Tasks</a>
                            </li>
                        </ul>
                    </li>
                    <!-- #END# Tasks -->
                    <li class="pull-right"><a href="<?php echo base_url();?>assets/javascript:void(0);" class="js-right-sidebar" data-close="true"><i class="material-icons">more_vert</i></a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>assets/javascript:void(0);" class="menu-toggle">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 - 2017 <a href="<?php echo base_url();?>assets/javascript:void(0);">AdminBSB - Material Design</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
        ...
        <aside id="rightsidebar" class="right-sidebar">
            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                <li role="presentation" class="active"><a href="<?php echo base_url();?>assets/#skins" data-toggle="tab">SKINS</a></li>
                <li role="presentation"><a href="<?php echo base_url();?>assets/#settings" data-toggle="tab">SETTINGS</a></li>
            </ul>
